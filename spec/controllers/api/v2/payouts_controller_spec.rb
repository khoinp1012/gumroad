    ...
    describe "when include_transactions parameter is set to true", :vcr do
      ...
      it "includes the transactions array with all balance affecting transactions" do
        ...
        expect(response_payout["transactions"]).to eq [
          ...
          { "type" => "Dispute won", "date" => @credit_for_dispute_won.balance.date.to_s, "purchase_id" => @regular_purchase.external_id, "item_name" => "", "buyer_name" => "", "buyer_email" => "", "taxes" => "", "shipping" => "", "sale_price" => 7.91, "gumroad_fees" => "", "net_total" => 7.91 },
