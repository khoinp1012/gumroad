...
configuration_by_env = {
  ...
  development: {
    protocol: "http",
    domain: "gumroad.localhost:3000",
    asset_domain: "gumroad.localhost:3000",
    root_domain: "gumroad.localhost:3000",
    short_domain: "gumroad.localhost:3000",
    discover_domain: "gumroad.localhost:3000",
    api_domain: "gumroad.localhost:3000",
    third_party_analytics_domain: "analytics.gumroad.localhost:3000",
    valid_third_party_analytics_host: "analytics.gumroad.localhost",
    valid_request_hosts: ["gumroad.localhost", "gumroad.localhost:3000", "127.0.0.1"],
    valid_api_request_hosts: ["gumroad.localhost:3000"],
    valid_discover_host: "gumroad.localhost",
    valid_cors_origins: [],
    internal_gumroad_domain: "gumroad.localhost",
    default_email_domain: "staging.gumroad.com",
    anycable_host: "gumroad.localhost",
  }
}
